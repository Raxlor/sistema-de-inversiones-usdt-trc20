...
<head>
    ...
    <title><?php echo $name_Web_title ?></title>
    <!-- Stylesheet File -->
            ...
            <div class="container">
                <div class="row align-items-center align-content-lg-center justify-content-center">
                    <div class="col-sm-12 col-md-6 ">
                        ...
                        <form class="contact-form-inner login_form" method="post" id="login_form" action="javascript:void(0)" enctype="multipart/form-data">
                            ...
                            <div class="" style="text-align-last: center;">
                                <p class="small mb-0 pb-lg-0"><a class="text-white-50" href="javascript:resert_password()">Forgot password?</a></p>
                            </div>
